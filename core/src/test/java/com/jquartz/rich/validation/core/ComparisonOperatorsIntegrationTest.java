...
public class ComparisonOperatorsIntegrationTest {
    ...
    public static Object[][] fieldToLiteralScenarios() {
        return new Object[][]{
                ...
                {ensureThat(SingleFieldSubject.class).field(FIELD).isGreaterOrCoequalTo(BigInteger.valueOf(10)).build(), 5, FALSE},
                {ensureThat(SingleFieldSubject.class).field(FIELD).isGreaterOrCoequalTo(BigInteger.valueOf(10)).build(), 10, TRUE},
                {ensureThat(SingleFieldSubject.class).field(FIELD).isGreaterOrCoequalTo(BigInteger.valueOf(10)).build(), 15, TRUE},
                ...
                {ensureThat(SingleFieldSubject.class).field(FIELD).isLessOrCoequalTo(BigInteger.valueOf(10)).build(), 15, FALSE},
                {ensureThat(SingleFieldSubject.class).field(FIELD).isLessOrCoequalTo(BigInteger.valueOf(10)).build(), 10, TRUE},
                {ensureThat(SingleFieldSubject.class).field(FIELD).isLessOrCoequalTo(BigInteger.valueOf(10)).build(), 5, TRUE},
                ...
                {ensureThat(SingleFieldSubject.class).field(FIELD).isGreaterOrCoequalTo(10).build(), 5, FALSE},
                {ensureThat(SingleFieldSubject.class).field(FIELD).isGreaterOrCoequalTo(10).build(), 10, TRUE},
                {ensureThat(SingleFieldSubject.class).field(FIELD).isGreaterOrCoequalTo(10).build(), 15, TRUE},
                ...
                {ensureThat(SingleFieldSubject.class).field(FIELD).isLessOrCoequalTo(10).build(), 15, FALSE},
                {ensureThat(SingleFieldSubject.class).field(FIELD).isLessOrCoequalTo(10).build(), 10, TRUE},
                {ensureThat(SingleFieldSubject.class).field(FIELD).isLessOrCoequalTo(10).build(), 5, TRUE},
    ...
    public static Object[][] fieldToFieldScenarios() {
        return new Object[][]{
                ...
                {ensureThat(TwoFieldsSubject.class).field(FIRST_FIELD).isGreaterOrCoequalToField(SECOND_FIELD).build(), 10, 5, TRUE},
                {ensureThat(TwoFieldsSubject.class).field(FIRST_FIELD).isGreaterOrCoequalToField(SECOND_FIELD).build(), 10, 10, TRUE},
                {ensureThat(TwoFieldsSubject.class).field(FIRST_FIELD).isGreaterOrCoequalToField(SECOND_FIELD).build(), 10, 15, FALSE},
                ...
                {ensureThat(TwoFieldsSubject.class).field(FIRST_FIELD).isLessOrCoequalToField(SECOND_FIELD).build(), 10, 15, TRUE},
                {ensureThat(TwoFieldsSubject.class).field(FIRST_FIELD).isLessOrCoequalToField(SECOND_FIELD).build(), 10, 10, TRUE},
                {ensureThat(TwoFieldsSubject.class).field(FIRST_FIELD).isLessOrCoequalToField(SECOND_FIELD).build(), 10, 5, FALSE},
