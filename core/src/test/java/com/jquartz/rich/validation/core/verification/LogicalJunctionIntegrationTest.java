...
public class LogicalJunctionIntegrationTest {
    ...
    public static Object[][] logicalJunctionScenarios() {
        VerificationLogic<SingleFieldSubject> isEqualToOneOfTwoNumbers = ensureThat(SingleFieldSubject.class)
                .field(FIELD)
                .isEqualTo(10)
                .or()
                .isEqualTo(20)
        ...
        VerificationLogic<SingleFieldSubject> isInRangeBetween = ensureThat(SingleFieldSubject.class)
                .field(FIELD)
        ...
        VerificationLogic<SingleFieldSubject> isInImpossibleRange = ensureThat(SingleFieldSubject.class)
                .field(FIELD)
                .isGreaterThan(20)
                .and()
                .isLessThan(10)
        ...
        VerificationLogic<SingleFieldSubject> isInNowPossibleRange = ensureThat(SingleFieldSubject.class)
                .field(FIELD)
