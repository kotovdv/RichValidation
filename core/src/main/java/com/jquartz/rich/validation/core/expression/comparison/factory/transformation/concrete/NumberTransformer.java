...
public class NumberTransformer {
    ...
    public static <R extends Number> Transformation<R> createTransformation(Function<Number, R> transformer, Class<R> resultingClass) {
        List<Function<Object, Object>> transformation = new LinkedList<>();
        transformation.add(value -> applyTransformation(transformer, value));

        return new Transformation<>(resultingClass, transformation);
    }
